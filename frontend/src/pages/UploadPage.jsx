    ...
    return (
        <div className="max-w-4xl mx-auto p-6 md:p-10 space-y-8 animate-in fade-in py-12 relative">
                    ...
                    >
                        <div className="relative mb-8">
                            ...
                            <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-cyan-500 rounded-full flex items-center justify-center shadow-xl shadow-cyan-500/30 relative z-10">
                                <Bot className="w-10 h-10 text-gray-900 animate-pulse" />
                            </div>
                        </div>
                        
                        <h2 className="text-2xl font-black text-gray-900 mb-2 tracking-tight">Analyzing Resume</h2>
            ...
            <div className={`text-center space-y-2 transition-opacity duration-300 ${isUploading ? 'opacity-0' : 'opacity-100'}`}>
                ...
                <p className="text-gray-500">Upload your PDF and paste a job description. Let our AI career coach score you.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="space-y-4 text-sm font-medium">
                    <label className="text-gray-700">1. Required: Resume PDF</label>
              ...
              ${isDragActive ? 'border-cyan-400 bg-cyan-950/20' : 'border-gray-300 bg-white shadow-sm hover:border-indigo-400/60'}`}>
                        <input {...getInputProps()} />
                        {file ? (
                ...
                <motion.div initial={{ x: 20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="space-y-6">
                    <div className="space-y-2 flex-grow">
                        <label className="text-gray-700 text-sm font-medium">2. Required: Job Description</label>
                        <div className="relative h-full text-base">
                            <textarea
                                ...
                                className="w-full h-full min-h-[160px] resize-y bg-white border border-gray-200 rounded-xl p-4 text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 block"
                            />
            ...
            <div className="flex flex-col items-center mt-8 gap-4">
                ...
                <button
                    ...
                    className="bg-gradient-to-r from-indigo-500 to-cyan-500 hover:from-indigo-600 hover:to-cyan-600 disabled:opacity-50 text-gray-900 font-bold text-lg px-12 py-4 rounded-full shadow-lg shadow-indigo-500/20 transition-all flex items-center gap-3 transform hover:scale-105"
                >
                    {isUploading ? (
                        <>
